App.controller('home', function (page) {
    if(typeof (localStorage)   !== 'undefined'){
        ...
        if(localStorage.getItem("recipient-list")  !== null){
            ...
            $.each(recipientList, function(index,value){
                $(page).find("#contact-list").append('<div class = "app-button redirect" data-target= "sendmail">' + value + '</div>');
            });	
  ...
  App.controller('sendmail', function (page) {
    ...
    $(page).find('#send-button')
                ...
                .on('click', function(){
                             ...
                             $.ajax({
                  type: 'GET',
                  url: 'http://localhost/sendmymail/sendmymail.php',
                  ...
                  success: function(data){
                    if(data.success == true){
                        ...
                        $(page).find("message").html("Your email coult not be sent - please try again later.");
                ...
                if(typeof(localStorage) !== 'undefined'){
                    ...
                    if($.inArray($("recipient-email").val(),recipientList)  == -1){ 
                        ...
                        console.log(recipientList.sort());
                    } 
